                ...
                <div className="container mt-5">
                    <div className="row fw-bold">
                        <div className="col-lg col-md-4 col-12 mb-lg-0 mb-4 footer-col text-left">
                            <p><strong className="text-primary h5 fw-bolder"> Our Services</strong></p>
                            <div className="">
                                <p><Link to='/'>Book Appointment</Link></p>
                                <p><Link to='/'>Contact Us</Link></p>
                                <p><Link to='/'>Gallery</Link></p>
                            </div>
                        </div>
                        <div className="col-lg col-md-4 col-12 mb-lg-0 mb-4 footer-col text-left">
                            <p><strong className="text-primary h5 fw-bolder"> More Info</strong></p>
                            <div className="">
                                <p><Link  to='/'>Book Now</Link></p>
                                <p><Link to='/'>Contact U</Link></p>
                                <p><Link to='/'>Gallery</Link></p>
                            </div>
                        </div>
                        <div className="col-lg col-md-4 col-12 mb-lg-0 mb-4 footer-col text-left">
                            <p><strong className="text-primary h5 fw-bolder"> Quick Links</strong></p>
                            <div className="">
                        ...
                        <div className="col-lg col-md-4 col-12 mb-lg-0 mb-4 footer-col text-left">
                            <p><strong className="text-primary h5 fw-bolder"> Contact us</strong></p>
                            <div className="">
                                <p className="d-flex">
                                ...
                                <p className="d-flex">
                                    ...
                                    <span>Vetghat Chowk, Itahari</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-sm-between flex-sm-row flex-column align-items-center ">
                        <p className='fs-5'>Ⓒ Hospital 2022. All rights reserved.</p>
                        <p className='fs-5'>
                            Developed by Bikal Siwakoti
                        </p>
                    </div>
                </div>
            </footer>
